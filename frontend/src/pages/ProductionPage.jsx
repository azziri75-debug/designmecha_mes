            ...
            <Table sx={{ tableLayout: 'fixed', minWidth: 1000 }}>
                <TableHead sx={{ '& th': { color: '#000000 !important', fontWeight: 'bold', bgcolor: '#f8f9fa' } }}>
                    <TableRow>
                        ...
                        <ResizableTableCell width={colWidths.note} onResize={handleResize('note')}>비고</ResizableTableCell>
                ...
                <TableBody>
                    {unplannedOrders.length === 0 && unplannedStockProductions.length === 0 ? (
                        <TableRow><TableCell colSpan={8} align="center">생산 대기 중인 항목이 없습니다.</TableCell></TableRow>
                    ) : (
                        <>
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <TableCell sx={{ textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', maxWidth: colWidths?.note || 150 }} title={order.note}>{order.note || '-'}</TableCell>
    ...
    return (
        <React.Fragment>
            ...
            >
                ...
                <TableCell sx={{ textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', maxWidth: colWidths?.note || 150 }} title={stockProduction.note}>{stockProduction.note || '-'}</TableCell>
    ...
    return (
        <TableContainer sx={{ boxShadow: 'none' }}>
            <Table sx={{ tableLayout: 'fixed', minWidth: 1200 }}>
                ...
                <TableBody>
                    {plans.length === 0 ? (
                        <TableRow><TableCell colSpan={13} align="center">데이터가 없습니다.</TableCell></TableRow>
                    ) : (
                        plans.map((plan) => (
                            <Row
                                key={plan.id}
