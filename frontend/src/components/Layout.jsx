...
const Layout = () => {
    ...
    const navItems = [
        ...
        { icon: Blocks, label: '생산제품관리', to: '/products/produced', menuKey: 'products' },
        { icon: Cpu, label: '부품관리', to: '/products/parts', menuKey: 'products' },
        { icon: DollarSign, label: '영업관리', to: '/sales', menuKey: 'sales' },
        ...
        { icon: Shield, label: '고객불만관리', to: '/complaints', menuKey: 'quality' },
        ...
        { icon: BarChart3, label: '결산자료', to: '/settlement', menuKey: 'sales' },
