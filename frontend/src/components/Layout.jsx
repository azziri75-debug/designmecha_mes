...
const Layout = () => {
    ...
    const navItems = [
        ...
        { icon: ShoppingCart, label: '자재 구매 관리', to: '/purchasing/materials', menuKey: 'purchasing' },
        { icon: ShoppingBag, label: '소모품 발주 관리', to: '/purchasing/consumables', menuKey: 'purchasing' },
