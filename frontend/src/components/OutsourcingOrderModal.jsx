...
const OutsourcingOrderModal = ({ isOpen, onClose, onSuccess, order, initialItems }) => {
    ...
    useEffect(() => {
        ...
        if (order) {
            ...
            const isStock = !!(firstItem?.plan?.stock_production_order_id || firstItem?.plan?.stock_production_id || firstItem?.stock_production_id || String(displayCode).includes('재고'));
